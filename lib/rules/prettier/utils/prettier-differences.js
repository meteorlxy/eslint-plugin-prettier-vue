  ...
  if (source !== prettierSource) {
    ...
    differences.forEach(difference => {
      switch (difference.operation) {
        case INSERT:
          reportInsert(context, difference.offset + offset, difference.insertText)
          break
        case DELETE:
          reportDelete(context, difference.offset + offset, difference.deleteText)
          break
        case REPLACE:
          reportReplace(context, difference.offset + offset, difference.deleteText, difference.insertText)
          break
        default:
      }
    })
